...
// Moves into position.
// Uses the 3rd through 12th parameters to specify the material.
// Draws a teapot.
void renderTeapot(GLfloat x, GLfloat y, GLfloat ambr, GLfloat ambg, GLfloat ambb, GLfloat difr, GLfloat difg, GLfloat difb,
